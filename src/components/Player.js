...
const Player = ({ setSongs, setCurrentSong, songs, setSongInfo, songInfo, audioRef, currentSong, isPlaying, setIsPlaying }) => {
  ...
  const skipTrackHandler = async (direction) => {
    ...
    if (direction === "skip-back") {
      // Attention quand on veut réaliser une boucle infinie en arrière, on risque d'arriver sur -1, ce qui fera crash notre tableau donc on va poser un check qui dit "si on arrive à -1, en fait va me chercher le dernier élément du tableau"
